...
Переписать конфигурацию в виде Java + Annotation-based конфигурации и добавить файл настроек
Локализовать выводимые сообщения и вопросы теста. Обернуть вызов одной из функций аспктом. <br>
Ecosystem:
> - Spring Context
> - AspectJ
